(function (global, factory) {
	typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('braintree-web/client'), require('braintree-web/hosted-fields')) :
	typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'braintree-web/client', 'braintree-web/hosted-fields'], factory) :
	(factory((global['react-braintree-fields'] = {}),global.React,global.PropTypes,global.Braintree,global.HostedFields));
}(this, (function (exports,React,PropTypes,Braintree,HostedFields) { 'use strict';
